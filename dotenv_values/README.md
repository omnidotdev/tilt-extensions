...
dotenv_values reads `.env` or another specified file and loads the key value pairs into the environment. Supports multi-line strings wrapped with double-quotes (`"`).
